...
# Load dataset
# Replace 'C:\Users\AMANDEEP SINGH\Desktop\titanic dataset.csv' with your dataset's file path or URL
df = pd.read_csv(r'C:\Users\AMANDEEP SINGH\Desktop\titanic dataset.csv')
